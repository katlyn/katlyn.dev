  ...
  education: [
    {
      ...
      startDate: "2019",
      blurb:
        "Covers the fundamentals of programming, hardware, and theory; with an emphasis on real-world application.",
    },
    {
  ...
  experience: [
    {
      ...
      description:
        "Develop and maintain customer-facing APIs to facilitate use of the Hydrolix Streaming Data Lake platform.",
    ...
    },
    {
      ...
      company:
        "University of Alaska, OIT Platforms, Applications, & Web Services Team",
      startDate: "Nov 2019",
      endDate: "Feb 2024",
      description:
        "Support staff, faculty, and student requests through web development and server administration.",
      skills: [
        "OmniCMS",
        "Javascript",
        "Typescript",
  ...
  projects: [
    {
      ...
      description:
        "Moderation and maintenance of a Discord group and associated tools that provides communication tools for UAF students and professors",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Creation and presentation of lectures regarding cyber Security, as well as maintenance of club infrastructure.",
      bullets: [
  ...
  awards: [
    {
      ...
      date: "2023",
      blurb:
        "Awarded to one student each year in recognition of their contributions and effort put towards their position.",
      quote:
        "[Katlyn's] highly valuable and much-needed web programming and systems administration skills and can-do attitude have been a great asset to the University.",
    },
  ],
};
